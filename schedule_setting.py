...
def job():
    ...
    post_paper_to_slack(date=date, word="Bethe", condition="topic_word", slack_channel="bot_arxiv_bethe_ansatz")
    post_paper_to_slack(date=date, word="tensor network", condition="topic_word", slack_channel="bot_arxiv_tensor_network")
